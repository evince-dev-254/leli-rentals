    ...
    return (
        <AdminLayout>
            <div className="p-6 md:p-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Profile Images</h1>
                    <p className="text-gray-600 dark:text-gray-400">User avatar management</p>
                </div>

                <Card>
                    <CardHeader>
                        <CardTitle>Profile Images Management</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center justify-center py-12">
                            <div className="text-center">
                                <Image className="h-16 w-16 mx-auto text-gray-400 mb-4" />
                                <p className="text-gray-500">Profile Images management interface coming soon...</p>
