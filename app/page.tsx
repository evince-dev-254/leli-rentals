    ...
    <div className="min-h-screen bg-background transition-all duration-500">
      ...
      >
        <div className="text-center text-white max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl p-3 sm:p-4 max-w-2xl mx-auto shadow-2xl fade-in-up stagger-2 transition-all duration-300">
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-center">
              ...
              <Button
                className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 h-10 text-sm font-semibold rounded-lg min-w-[80px] w-full sm:w-auto btn-animate shadow-lg hover:shadow-xl transition-all duration-200"
