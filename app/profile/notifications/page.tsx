      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">
            <GradientText from="from-blue-600" to="to-purple-600">Notification Settings</GradientText>
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Manage how you receive notifications</p>
        </div>
