...
export default function ConfirmSignUpEmail({
    ...
    confirmLink = "https://leli.rentals/confirm?token=TOKEN",
...
const buttonStyle: React.CSSProperties = { backgroundColor: "#2563eb", color: "#ffffff", padding: "12px 24px", borderRadius: "8px", textDecoration: "none", display: "inline-block", fontWeight: 600, fontSize: "16px", margin: "0 auto", textAlign: "center" };
