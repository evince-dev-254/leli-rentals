...
"[project]/lib/favorites-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/messages-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const MessagesContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function MessagesProvider({ children }) {
    ...
    const setupSubscription = (uid)=>{
        const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('messages_channel').on('postgres_changes', {
            event: '*',
            schema: 'public',
            table: 'messages',
    ...
    const fetchConversations = async (uid)=>{
        try {
            const { data: convs, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('conversations').select(`
          id,
    ...
    const sendMessage = async (conversationId, content)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('messages').insert({
    ...
    const startConversation = async (ownerId, ownerName, ownerAvatar, listingId, listingTitle, listingImage, initialMessage)=>{
        if (!currentUserId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("You must be logged in to send messages");
            router.push("/sign-in");
            return;
        }
        try {
            // Check existing
            const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('conversations').select('id').eq('listing_id', listingId).or(`and(participant_1_id.eq.${currentUserId},participant_2_id.eq.${ownerId}),and(participant_1_id.eq.${ownerId},participant_2_id.eq.${currentUserId})`).single();
            let convId = existing?.id;
            if (!convId) {
                // Create new
                const { data: newConv, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('conversations').insert({
            ...
            const updatedConvs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('conversations') // Re-fetch to confirm
            .select('*').eq('id', convId);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to start conversation");
        }
    };
...
_s(MessagesProvider, "ioHoigBKh+ocMDdTSOS9mwV31zs=", false, function() {
    return [
...
function useMessages() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(MessagesContext);
    if (!context) {
...
//# sourceMappingURL=_80073b1a._.js.map