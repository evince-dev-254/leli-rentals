...
function CookieConsent() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "glass-card rounded-2xl p-6 shadow-lg border border-border/50 bg-background/95 backdrop-blur-lg",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/lib/favorites-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FavoritesProvider({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(FavoritesContext.Provider, {
        ...
        fileName: "[project]/lib/favorites-context.tsx",
        lineNumber: 52,
        columnNumber: 5
    }, this);
}
...
;
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$esm$2f$wrapper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])(("TURBOPACK compile-time value", "https://tdtjevpnqrwqcjnuywrn.supabase.co") ?? '', ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRkdGpldnBucXJ3cWNqbnV5d3JuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ4NzA0NzcsImV4cCI6MjA4MDQ0NjQ3N30.YX1s_FIYlL7L86mlEWI5cFeiGUCfuj458tvk3Ahonvs") ?? '');
}),
"[project]/lib/messages-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const MessagesContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function MessagesProvider({ children }) {
    ...
    const setupSubscription = (uid)=>{
        const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].channel('messages_channel').on('postgres_changes', {
            event: '*',
            schema: 'public',
            table: 'messages',
    ...
    const fetchConversations = async (uid)=>{
        try {
            const { data: convs, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('conversations').select(`
          id,
        ...
        `).or(`participant_1_id.eq.${uid},participant_2_id.eq.${uid}`).order('created_at', {
                ascending: false
            });
            ...
            const formattedConversations = convs.map((conv)=>{
                ...
                const unread = messages.filter((m)=>m.sender_id !== uid && !m.is_read).length;
                return {
                    id: conv.id,
    ...
    const sendMessage = async (conversationId, content)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('messages').insert({
    ...
    const startConversation = async (ownerId, ownerName, ownerAvatar, listingId, listingTitle, listingImage, initialMessage)=>{
        if (!currentUserId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("You must be logged in to send messages");
            router.push("/sign-in");
            return;
        }
        try {
            // Check existing
            const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('conversations').select('id').eq('listing_id', listingId).or(`and(participant_1_id.eq.${currentUserId},participant_2_id.eq.${ownerId}),and(participant_1_id.eq.${ownerId},participant_2_id.eq.${currentUserId})`).single();
            let convId = existing?.id;
            if (!convId) {
                // Create new
                const { data: newConv, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('conversations').insert({
            ...
            const updatedConvs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('conversations') // Re-fetch to confirm
            .select('*').eq('id', convId);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to start conversation");
        }
    };
    const markAsRead = async (conversationId)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('messages').update({
                is_read: true
            }).eq('conversation_id', conversationId).neq('sender_id', currentUserId);
        } catch (err) {
            console.error("Error marking read:", err);
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(MessagesContext.Provider, {
        value: {
            conversations,
            activeConversation,
        ...
        fileName: "[project]/lib/messages-context.tsx",
        lineNumber: 259,
        columnNumber: 5
    }, this);
}
function useMessages() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(MessagesContext);
    if (!context) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee2320f9._.js.map